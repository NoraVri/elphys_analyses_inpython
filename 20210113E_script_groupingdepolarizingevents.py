...
neuron_name = '20210113E'
singleneuron_data = SingleNeuron(neuron_name)

singleneuron_data.plot_rawdatablocks(time_axis_unit='s', segments_overlayed=False)

# notes summary:
# just a single trace of spont.activity, initially oscillating with amp ~8mV going down to ~1mV within 4 minutes.
...
# just two spont.APs recorded, and those both got picked up nicely.
...
# notes:
# no light-evoked events recorded for this neuron.
...
# notes:
# not a single event got picked up.
