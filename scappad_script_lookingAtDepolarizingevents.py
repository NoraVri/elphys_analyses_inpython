...
# %%
# Questions:
# Q1] what portion of neurons in the dataset have large-amplitude (>3mV) fast depolarizing events?
#   How many of these have events of multiple amplitudes (but same decay waveform)?
#   What are the rise-time / half-width / amplitude parameters that define these events across all neurons in the dataset?
