...
## notes on raw data
# according to notes from the day, definitely saw a spike or two, but doesn't seem like cell really wanted to get recorded.
# Looking at data now whatever 'spikes' there are may as well be noise; they're also clipped at 200pA (in file gapFree_0002 - maybe a gain change?)
