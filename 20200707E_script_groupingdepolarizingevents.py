...
neuron_name = '20200707E'
singleneuron_data = SingleNeuron(neuron_name)

singleneuron_data.plot_rawdatablocks(time_axis_unit='s', segments_overlayed=False)

# notes summary:
# Neuron with some nice light responses and nothing much else really besides a resting voltage.
...
# no spont.APs in this neuron; a single light-evoked AP and some APs riding +DC pulses early on in the recording
# all got picked up nicely.
...
# notes:
# not all light responses are >2mV, but those that are all got picked up; definitely
# nothing that is in fact spont. got labeled as evoked.
...
# notes:
# No actual spont.events got picked up, just noise-things occurring as the cell dies at the end of recordings.
