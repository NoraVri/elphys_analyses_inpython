...
class SingleNeuron_Analyses():
    ...
    def __init__(self, singleneuron_name, path="D:\\hujigoogledrive\\research_YaromLabWork\\data_elphys_andDirectlyRelatedThings\\olive"):
        ...
        self.getstoredresults()

    def getstoredresults(self):
        """ This function determines whether a json file carrying singleneuron_name
        is present in a folder with 'myResults';
        if yes, it will populate the class instance with results found in the json file.
        """
