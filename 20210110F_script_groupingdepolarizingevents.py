...
# notes summary:
# pretty nice recording, though neuron not really doing anything interesting spontaneously.
...
# light- and DC-evoked APs got picked up nicely; no spont.APs recorded in this neuron
...
# notes:
# light responses are often just a bit <2mV, but otherwise got picked up nicely; did not see anything labeled that is in fact spont.
...
# notes:
# just two events got picked up, and they're both T-type Ca-peaks caused by release from -DC.
# Labeling them as currentpulsechange:
