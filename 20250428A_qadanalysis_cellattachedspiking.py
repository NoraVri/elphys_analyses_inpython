...
## importing the data
neuron_name = '20250428A'
neuron_data = SingleNeuron(neuron_name)
neuron_data.plot_rawdatablocks()

## notes on raw data
# not even worth analyzing: yes, it's clearly spiking, but signal never great to begin with and never getting better no matter what I'm trying.
# freq. 32-40Hz, from counting spikes on tuning pulses manually
