...
cell20190812A.depolarizing_events[intermediateamp_events].plot.scatter(x='rise_time', y='half_width', c='amplitude', colormap='viridis')
# %%
# definitelyfastevents = cell20190812A.depolarizing_events.amplitude > 5
# cell20190812A.plot_depolevents_overlayed(definitelyfastevents,
#                                          do_baselining=True,
#                                          colorby_measure='baselinev',
#                                          plt_title='definitely fast-events')
