...
# # running get_depolarizingevents again on all neurons (whenever something in the function changes)
...
# yet definitely not fast-events.
...
# 20200707E:
#
# 20200708B: obviously has spont. fast-events (definitely, and only of the kind we're looking for).
